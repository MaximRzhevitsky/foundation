...
$opt_name = 'max_foundation';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'global',
		'desc'             => esc_html__( 'options for global fields', 'your-textdomain-here' ),
...
Redux::set_section(
	...
	array(
		...
		'desc'             => esc_html__( 'footer fields', 'your-textdomain-here' ),
		'id'               => 'global-footer',
		'subsection'       => true,
		...
		'fields'           => array(
			array(
				'id'       => 'left title',
				'type'     => 'text',
				'title'    => esc_html__( 'left title', 'your-textdomain-here' ),
				'default'  => '',
			),
			array(
				'id'       => 'center title',
				'type'     => 'text',
				'title'    => esc_html__( 'center title', 'your-textdomain-here' ),
				'default'  => '',
				),
			array(
				'id'          => 'right title',
				'type'        => 'text',
				'title'       => esc_html__( 'right title', 'your-textdomain-here' ),
				'default'  => '',
			),
			array(
				'id'       => 'left text',
				'type'     => 'textarea',
				'title'    => esc_html__( 'area for left text', 'your-textdomain-here' ),
				'default'  => 'Left text',
			),
			array(
				'id'       => 'right text',
				'type'     => 'textarea',
				'title'    => esc_html__( 'area for right text', 'your-textdomain-here' ),
				'default'  => 'right text',
			),
			array(
				'id'       => 'subscribe title',
				'type'     => 'text',
				'title'    => esc_html__( 'subscribe title', 'your-textdomain-here' ),
				'default'  => '',
			),
			array(
				'id'       => 'follow title',
				'type'     => 'text',
				'title'    => esc_html__( 'follow title', 'your-textdomain-here' ),
				'default'  => '',
			),
			...
			array(
				'id'       => 'widget for mail',
				'type'     => 'text',
				'title'    => esc_html__( 'insert the mail widget', 'your-textdomain-here' ),
				'default'  => '',
			),
		),
	)
